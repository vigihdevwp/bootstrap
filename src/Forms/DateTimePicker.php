...
final class DateTimePicker extends AbstractFloatingLabel
{
    ...
    public function __construct(
        ...
        private readonly string $icon = 'calendar_month',
    ...
    private function textInput(): string
    {
        ...
        Html::addCssClass($new->inputOptions, 'date-time-picker user-select-none');
