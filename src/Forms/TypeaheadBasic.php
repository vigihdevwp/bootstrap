...
final class TypeaheadBasic extends AbstractFloatingLabel
{
    ...
    private function textInput(): string
    {
        ...
        $new->inputOptions = ArrayHelper::merge($new->inputOptions, [
            'data-options' => [
                ...
                'options' => Json::encode($this->dataOptions)
            ]
        ]);
        Html::addCssClass($new->inputOptions, 'typeahead-basic user-select-none');
